...
export const ROLE_VIEWS: Record<Role, ModuleId[]> = {
  ...
  control_interno: ["dashboard", "revisoria_fiscal"],
  auditor_control_interno: ["dashboard", "revisoria_fiscal"],
  revisor_fiscal: ["dashboard", "revisoria_fiscal"],
  centro_control: [
    "dashboard",
    "logistica",
    "qhse",
  ...
  coordinador_comercial: ["dashboard", "comercial"],
  director_comercial: ["dashboard", "comercial"],
  ...
  gestor_comercial: ["dashboard", "comercial"],
  gestor_contable: [
    "dashboard",
    "contabilidad",
    "tesoreria",
  ...
  qhse: ["dashboard", "qhse", "logistica", "taller", "rrhh", "call_center"],
  lider_qhse: [
    "dashboard",
    "qhse",
    "logistica",
  ...
  vinculaciones: ["dashboard", "rrhh"],
  gestor_vinculaciones: ["dashboard", "rrhh"],
  ...
  recepcionista: ["dashboard", "call_center"],
