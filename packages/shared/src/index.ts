...
export const ROLE_LABELS: Record<Role, string> = {
  ...
  lider_ti: "Líder TI / Tecnología e Infraestructura",
  gestor_documental: "Gestor documental / Archivo & Papelería",
  recepcionista: "Recepcionista / Concierge",
  recepcion: "Recepcionista (legado)",
  tecnologia: "Tecnología (legado → Líder TI)",
  ...
  tesoreria: "Tesorería & Dispersión de caja",
  director_financiero: "Director financiero (CFO)",
  qhse: "QHSE (legado)",
  lider_qhse: "Líder QHSE / Calidad & PESV",
  compras: "Compras (legado)",
  lider_compras: "Líder Compras & Abastecimiento",
  director_operativo: "Director operativo / Estrategia de flota",
  gestor_operativo: "Gestor operativo / Micro-Despacho 4.0",
  ...
  operador_centro_control: "Operador centro de control / Watchtower 24/7",
  control_interno: "Control interno (legado)",
  auditor_control_interno: "Auditor control interno / Forense",
  presidencia: "Presidencia (legado)",
  presidente: "Presidente / CEO / Founder's Canvas",
  vinculaciones: "Vinculaciones (legado)",
  gestor_vinculaciones: "Gestor vinculaciones / Smart Onboarding",
  coordinador_comercial: "Coordinador comercial / Licitaciones B2G",
  gestor_comercial: "Gestor comercial / Ejecutivo de ventas",
  director_comercial: "Director comercial / B2B Sales Pipeline",
  gerente_general: "Gerente general / Executive Hub",
  juridico: "Jurídico (legado)",
  director_juridico: "Director jurídico / Legal & Compliance",
  revisor_fiscal: "Revisor fiscal / Tax",
  coordinador_taller: "Coordinador taller 4.0",
  auxiliar_contable_taller: "Auxiliar contable taller",
  auxiliar_almacen_taller: "Auxiliar almacén taller / Smart Warehouse",
  mecanico: "Mecánico / FSG Tech App",
  coordinador_patio: "Coordinador patio / Smart Yard",
  auxiliar_patio: "Auxiliar patio / Lavado Smart Yard",
  conductor: "Conductor / FSG Pilot App",
