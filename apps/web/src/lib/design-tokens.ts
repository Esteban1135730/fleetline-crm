...
export const lightTokens: DesignTokens = {
  ...
  border: "#E2E8F0",
  borderActive: "rgba(0, 180, 216, 0.35)",
  primary: "#00B4D8",
  primaryFg: "#FFFFFF",
  primaryGlow: "rgba(0, 180, 216, 0.28)",
  secondary: "#0891B2",
  success: "#10B981",
  warning: "#D97706",
  danger: "#DC2626",
  ...
  field: "#FFFFFF",
  chartGrid: "#94A3B8",
  glowActive: "0 0 15px rgba(0, 180, 216, 0.22)",
  glowText: "none",
  onWarning: "#1A1200",
  onPrimary: "#FFFFFF",
  contrastFg: "#FFFFFF",
  scrim: "rgba(5, 11, 20, 0.35)",
  chartMuted: "#64748B",
  chartNeutral: "#94A3B8",
  mapRoute: "#10B981",
  mapTileUrl:
  ...
  shadowPanel: "0 10px 30px rgba(0, 0, 0, 0.04)",
  shadowInset: "0 0 0 1px rgba(255, 255, 255, 0.02)",
  glowSuccess: "0 0 8px color-mix(in srgb, #10B981 45%, transparent)",
  glowWarning: "0 0 8px color-mix(in srgb, #D97706 40%, transparent)",
  glowDanger: "0 0 8px color-mix(in srgb, #DC2626 45%, transparent)",
  glowDangerStrong: "0 0 16px color-mix(in srgb, #DC2626 55%, transparent)",
  mapPinShadow: "0 2px 8px rgba(0, 0, 0, 0.35)",
};
