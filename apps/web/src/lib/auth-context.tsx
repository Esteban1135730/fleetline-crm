...
export function homePathForRole(role: Role | string): string {
  ...
  const ROLE_HOME: Partial<Record<string, string>> = {
    ...
    director_operativo: "/operaciones/tablero",
    gestor_operativo: "/operaciones/tablero",
    coordinador_campo: "/operaciones/tablero",
    operador_centro_control: "/operaciones/tablero",
    ...
    director_comercial: "/comercial/tablero",
    gestor_comercial: "/comercial/tablero",
    coordinador_comercial: "/comercial/tablero",
    tesoreria: "/tesoreria",
    centro_control: "/operaciones/tablero",
    conductor: "/pilot",
    coordinador_patio: "/patio/porteria",
    auxiliar_patio: "/patio/porteria",
